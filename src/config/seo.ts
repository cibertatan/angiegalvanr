export const SEO_CONFIG = {
  ...
  pages: {
    ...
    about: {
      ...
      description: "Conoce más sobre Angie Galvan R, mi experiencia profesional, habilidades y pasión por el desarrollo web.",
      keywords: "Angie Galvan R, sobre mí, experiencia, habilidades, biografía"
    },
    projects: {
    ...
    contact: {
      ...
      description: "Contacta con Angie Galvan R para colaboraciones, proyectos o consultas profesionales.",
      keywords: "Angie Galvan R, contacto, colaboración, proyectos"
    }
  }
}; 